<%@ Page Title="" Language="C#" MasterPageFile="~/View/Menu/Menu.Master" AutoEventWireup="true" CodeBehind="BuscarBovino.aspx.cs" Inherits="Ejemplo.View.Bovinos.BuscarBovino" %>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="width: 300px">
                                                    ...
                                                    <asp:LinkButton Style="color: black" CommandArgument='<%#Eval("idbovino")+","+Eval("categoria")+","+Eval("fecha_ingreso")+","+Eval("marca")+","+Eval("raza")+","+Eval("edad_ingreso")+","+Eval("peso_ingreso")+","+Eval("peso_venta")+","+Eval("fecha_venta")%>' OnCommand="Modificar" runat="server" CommandName="traer"><i class="fa fa-pencil"></i>
                                                    Modificar</asp:LinkButton>
                                                </td>
                                                <td style="width: 300px">

                                                    <asp:LinkButton Style="color: black" CommandArgument='<%#Eval("idbovino")+","+Eval("categoria")+","+Eval("marca")%>' OnCommand="Eliminar" runat="server" CommandName="traer"><i class="fa fa-pencil"></i>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col col-md-2">
                                ...
                                <input runat="server" type="text" id="IdBov" name="ubicaiones" class="form-control">
                            </div>
                            </div>
                            <br>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-11 col-md-9">
                                <input runat="server" type="date" id="fechai" name="nombres" class="form-control">
                            </div>
                          </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-11 col-md-9">
                                <input runat="server" type="text" id="marca" name="ubicaiones" class="form-control">
                            </div>
                              </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-11 col-md-9">
                                <input type="text" runat="server" id="raza" name="areas" class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-2">
                                <label for="nf-password" class=" form-control-label">Edad de Ingreso</label>
                                     </div>
                                <div class="col-11 col-md-9">
                                <input type="text" runat="server" id="edad" name="areas" class="form-control">
                            </div>
                           </div>                           
                            <br>
                           ...
                           <div class="row form-group">
                                <div class="col col-md-2">
                                <label for="nf-password" class=" form-control-label">Peso de Ingreso</label>
                                    </div>
                                <div class="col-11 col-md-9">
                                <input type="text" runat="server" id="peso" name="areas" class="form-control">
                            </div>
                            </div>                           
                            <br>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-2">
                                <label for="nf-password" class=" form-control-label">Peso de Venta</label>
                                  </div>
                                <div class="col-11 col-md-9">
                                <input type="text" runat="server" id="PesoV" name="areas" class="form-control">
                            </div>
                            </div>                           
                            <br>
                             ...
                             <div class="row form-group">
                                <div class="col col-md-2">
                                <label for="nf-password" class=" form-control-label">Fecha de Venta</label>
                                </div>
                                <div class="col-11 col-md-9">
                                <input type="date" runat="server" id="fechaV" name="areas" class="form-control">
                            </div>
                            </div>                           
                            <br>
